...
"                      ^^^^^^^
syn region  xmlString contained start=+"+ end=+"+ contains=xmlEntity,@Spell,wonderKey display
...
if exists('g:xml_syntax_folding')
	...
	\ fold
	\ contains=xmlTag,xmlEndTag,xmlCdata,xmlUseLua,xmlRegion,xmlComment,xmlEntity,xmlProcessing,@xmlRegionHook,@Spell
	\ keepend
	\ extend
...
"
syn include @xmlLua syntax/lua.vim
syn region    xmlCdata
    \ start=+<!\[CDATA\[+
    \ end=+]]>+
    \ contains=xmlCdataStart,xmlCdataEnd,@xmlCdataHook,@Spell,@xmlLua
    \ keepend
    \ extend

syn region    xmlUseLua
    \ start=+<@useLua>+
    \ end=+</@useLua>+
    \ contains=xmlCdataStart,xmlCdataEnd,@xmlCdataHook,@Spell,@xmlLua
    \ keepend
